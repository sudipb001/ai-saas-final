# AI SaaS Project - Reference Codebase

## Project Overview

AI Document Assistant SaaS built with Next.js App Router and TypeScript, featuring document upload and extraction workflows, AI chat and summarization endpoints, plan-aware usage control, and subscription handling integrated with Supabase/PostgreSQL and OpenAI.

Technology stack: Next.js App Router, TypeScript, Tailwind CSS, Supabase, PostgreSQL, OpenAI API, Razorpay (simulated), Vercel deployment.
...
app/api/document/extract/route.ts
